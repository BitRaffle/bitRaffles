<template>
  <div>
    <div class="bg-gray-900">
      ...
      <section>
        <div class="pt-2 pb-6 px-8 bg-gray-700">
          <div class="flex flex-wrap items-center justify-between -mx-2">
            <div class="w-full sm:w-auto px-2 mb-6 lg:mb-0">
              <h4 class="text-2xl font-bold text-white tracking-wide leading-7 mb-1">Overview</h4>
              <div class="flex items-center">
                <a class="text-xs text-gray-300" href="#">Dashboard</a>
                <span class="inline-block h-1 w-1 mx-2 bg-gray-300 rounded-full"></span>
                <a class="text-xs text-gray-300" href="#">Overview</a>
              </div>
            </div>
              ...
              <div class="sm:flex items-center">
                ...
                <div class="w-full sm:w-auto">
                  <a class="inline-flex items-center justify-center py-2 pl-2 pr-3 bg-gray-500 hover:bg-gray-400 hover:bg-opacity-40 transition duration-150 rounded-full" href="#">
                    <img class="h-8 w-8 mr-3 rounded-full object-cover" src="~/assets/img/user-02.jpg" alt="">
                    <h4 class="text-white font-extrabold tracking-wide mr-5 avatar">J D</h4>
        ...
        <div class="container px-4 mx-auto">
          <div class="flex flex-wrap -mx-3 -mb-6">
            <div class="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
              <div class="h-full max-w-sm mx-auto p-6 bg-gray-700 rounded-xl">
                <div class="flex flex-shrink-0 w-12 h-12 mb-4 items-center justify-center bg-blue-500 bg-opacity-20 text-blue-500 rounded-xl">
                  <svg width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M17 3.50002H10.72L10.4 2.50002C10.1926 1.91325 9.80775 1.40553 9.2989 1.04718C8.79005 0.688841 8.18236 0.497623 7.56 0.500022H3C2.20435 0.500022 1.44129 0.816093 0.87868 1.3787C0.316071 1.94131 0 2.70437 0 3.50002V16.5C0 17.2957 0.316071 18.0587 0.87868 18.6213C1.44129 19.184 2.20435 19.5 3 19.5H17C17.7956 19.5 18.5587 19.184 19.1213 18.6213C19.6839 18.0587 20 17.2957 20 16.5V6.50002C20 5.70437 19.6839 4.94131 19.1213 4.3787C18.5587 3.81609 17.7956 3.50002 17 3.50002ZM18 16.5C18 16.7652 17.8946 17.0196 17.7071 17.2071C17.5196 17.3947 17.2652 17.5 17 17.5H3C2.73478 17.5 2.48043 17.3947 2.29289 17.2071C2.10536 17.0196 2 16.7652 2 16.5V3.50002C2 3.23481 2.10536 2.98045 2.29289 2.79292C2.48043 2.60538 2.73478 2.50002 3 2.50002H7.56C7.76964 2.49948 7.97416 2.56484 8.14463 2.68686C8.3151 2.80889 8.44291 2.9814 8.51 3.18002L9.05 4.82002C9.11709 5.01864 9.2449 5.19116 9.41537 5.31318C9.58584 5.4352 9.79036 5.50056 10 5.50002H17C17.2652 5.50002 17.5196 5.60538 17.7071 5.79292C17.8946 5.98045 18 6.23481 18 6.50002V16.5Z" fill="#194BFB"></path></svg></div>
            ...
            <div class="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
              <div class="relative h-full max-w-sm mx-auto p-6 bg-gray-700 rounded-xl">
                ...
                <div class="card-body mt-2" style="margin-top:2px">
                  ...
                  <div class="flex justify-center items-center">
                          <canvas id="canvas" width="200" height="200" class="mt-2">
                              <p class="text-white">Sorry, your browser doesn't support canvas. Please try another.</p>
                          </canvas>
              </div>
                <h2 class="card-title text-center mx-auto text-gray-50">Voila!!!
                </h2>
                <p class="mx-auto text-center text-gray-50" id="message">One spin away from being a winner!!!</p>
                
              </div>
              </div>
            </div>
            <div class="w-full lg:w-2/4 px-3 mb-6">
              <div class="relative h-full max-w-sm md:max-w-none mx-auto p-6 bg-gray-700 rounded-xl">
                <div class="flex flex-wrap items-center justify-between -mx-2">
                  ...
                  <div class="mt-3 rounded-lg border-gray-300 bg-blue-400 dark:border-gray-600 h-56 w-full">
                    <div class="flex justify-between items-center mb-4">
                        <div class="w-20 ml-4 mt-4">
                            <img src="https://img.icons8.com/office/80/sim-card-chip.png" alt="Mastercard Logo" class="w-full h-16 m-4">
                        </div>
      ...
      <section class="py-3">
        <div class="container px-4 mx-auto">
          <div class="pt-6 pb-8 bg-gray-700 rounded-xl">
            <div class="px-6">
              <div class="mb-6">
                <h4 class="text-lg text-gray-100 font-semibold mb-6">TRANSACTION HISTORY</h4>
                <div class="md:flex items-center">
                  <div class="relative inline-flex items-center h-14 w-full max-w-xxs py-4 px-3 mb-5 md:mb-0 mr-6 border border-gray-400 hover:border-white focus-within:border-green-500 rounded-lg">
                    <span class="absolute bottom-full left-0 ml-3 -mb-1 transform translate-y-0.5 text-xs font-semibold text-gray-100 px-1 bg-gray-500">Search</span>
                    ...
                    <input class="block w-full ml-2 outline-none bg-transparent text-sm text-gray-100 font-medium" id="messagesInput1-1" placeholder="Search history..." type="text" name="">
                  </div>
                  <a class="inline-block px-5 py-4 leading-6 text-white font-semibold bg-blue-500 hover:bg-blue-600 rounded-lg transition duration-100" href="#">SEARCH</a>
                </div>
              </div>
              <div class="w-full pb-6 overflow-x-auto">
                <table class="w-full min-w-max">
                  <thead>
                    <tr class="text-left">
                      <th class="p-0">
                        <div class="h-12 py-3 px-6 rounded-l-xl bg-gray-600">
                          <span class="text-xs text-gray-300 font-semibold">TRANSACTION</span>
                        </div>
                      </th>
                      <th class="p-0">
                        <div class="h-12 py-3 px-6 bg-gray-600">
                          <span class="text-xs text-gray-300 font-semibold">TIME/DATE</span>
                        </div>
                      </th>
                      <th class="p-0">
                        <div class="h-12 py-3 px-6 bg-gray-600">
                  ...
                  <tbody>
                      ...
                      <td class="p-0">
                        <div class="flex items-center h-16 px-6">
                          <div class="flex h-full items-center">
                            <div class="flex items-center justify-center w-8 h-8 mr-3 bg-gray-400 rounded-full">
                              <svg width="14" height="12" viewbox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M11.6668 0.666504H2.3335C1.80306 0.666504 1.29436 0.877218 0.919283 1.25229C0.54421 1.62736 0.333496 2.13607 0.333496 2.6665V9.33317C0.333496 9.8636 0.54421 10.3723 0.919283 10.7474C1.29436 11.1225 1.80306 11.3332 2.3335 11.3332H11.6668C12.1973 11.3332 12.706 11.1225 13.081 10.7474C13.4561 10.3723 13.6668 9.8636 13.6668 9.33317V2.6665C13.6668 2.13607 13.4561 1.62736 13.081 1.25229C12.706 0.877218 12.1973 0.666504 11.6668 0.666504ZM2.3335 1.99984H11.6668C11.8436 1.99984 12.0132 2.07008 12.1382 2.1951C12.2633 2.32012 12.3335 2.48969 12.3335 2.6665L7.00016 5.91984L1.66683 2.6665C1.66683 2.48969 1.73707 2.32012 1.86209 2.1951C1.98712 2.07008 2.15668 1.99984 2.3335 1.99984ZM12.3335 9.33317C12.3335 9.50998 12.2633 9.67955 12.1382 9.80458C12.0132 9.9296 11.8436 9.99984 11.6668 9.99984H2.3335C2.15668 9.99984 1.98712 9.9296 1.86209 9.80458C1.73707 9.67955 1.66683 9.50998 1.66683 9.33317V4.1865L6.6535 7.23317C6.75484 7.29168 6.8698 7.32249 6.98683 7.32249C7.10385 7.32249 7.21882 7.29168 7.32016 7.23317L12.3335 4.1865V9.33317Z" fill="#C0C8D2"></path>
                              </svg>
                            </div>
                            <span class="text-sm font-medium text-gray-100">Mailing Naming 1</span>
                          </div>
                        </div>
                      </td>
                      <td class="p-0">
                        <div class="flex items-center h-16 px-6">
                          <span class="text-sm font-medium text-gray-100">Every 3rd day of the month</span>
                        </div>
                      </td>
                      <td class="p-0">
                        <div class="flex items-center h-16 px-6">
                          <span class="text-sm font-medium text-gray-100">$45.66</span>
                        </div>
                      </td>
                      <td class="p-0">
                        <div class="flex items-center h-16 px-6">
                          <span class="text-sm font-medium text-gray-100">SUCCESSFUL</span>
                        </div>
                      </td>
                      <td class="p-0">
                    ...
                    <tr>
                      ...
                      <td class="p-0">
                        <div class="flex items-center h-16 px-6">
                          <span class="text-sm font-medium text-gray-100">$200</span>
                        </div>
                      </td>
                      <td class="p-0">
                        <div class="flex items-center h-16 px-6">
                    ...
                    <tr>
                      ...
                      <td class="p-0">
                        <div class="flex items-center h-16 px-6">
                          <span class="text-sm font-medium text-gray-100">$150.55</span>
                        </div>
                      </td>
                      <td class="p-0">
                        <div class="flex items-center h-16 px-6">
                          <span class="text-sm font-medium text-gray-100">FAILED</span>
                        </div>
                      </td>
                      <td class="p-0">
                    ...
                    <tr>
                      ...
                      <td class="p-0">
                        <div class="flex items-center h-16 px-6">
                          <span class="text-sm font-medium text-gray-100">$25.90</span>
                        </div>
                      </td>
                      <td class="p-0">
                        <div class="flex items-center h-16 px-6">
                    ...
                    <tr>
                      ...
                      <td class="p-0">
                        <div class="flex items-center h-16 px-6">
                          <span class="text-sm font-medium text-gray-100">$550.55</span>
                        </div>
                      </td>
                      <td class="p-0">
                        <div class="flex items-center h-16 px-6">
                    ...
                    <tr>
                      ...
                      <td class="p-0">
                        <div class="flex items-center h-16 px-6">
                          <span class="text-sm font-medium text-gray-100">$150</span>
                        </div>
                      </td>
                      <td class="p-0">
                        <div class="flex items-center h-16 px-6">
            ...
            <div class="flex flex-wrap items-center justify-between px-6 pt-8 border-t border-gray-400">
              <div class="w-full sm:w-auto mb-6 sm:mb-0">
                <div class="flex items-center justify-between">
                  <p class="text-sm font-medium text-gray-400">
                    ...
                    <span>to</span>
                    <span class="px-px text-gray-200">10</span>
              ...
              <div class="w-full sm:w-auto mb-6 sm:mb-0">
                <div class="flex flex-wrap items-center -m-1.5">
                  <div class="w-auto p-1.5"><a class="inline-flex items-center h-9 py-1 px-4 text-xs text-gray-400 font-semibold bg-gray-600 hover:bg-gray-700 rounded-lg transition duration-200" href="#">Previous</a></div>
                  <div class="w-auto p-1.5"><a class="inline-flex items-center h-9 py-1 px-4 text-xs text-blue-50 font-semibold bg-blue-500 hover:bg-blue-600 rounded-lg transition duration-200" href="#">Next</a></div>
                </div>
              </div>
            </div>
          </div>
...
// import AsideBar from '~/components/utilities/AsideBar.vue';
...
// Start the countdown timer
    ...
    methods: {
        payWinner(){
            ...
            url: 'https://501a-102-89-33-66.ngrok-free.app/bitplay/api/users/paywinner',
            headers: { 
       ...
       spin() {
        ...
        getQueue() {
            ...
            let config = {
                method: 'get',
                maxBodyLength: Infinity,
                url: 'https://501a-102-89-33-66.ngrok-free.app/bitplay/api/users/queue',
                headers: {
    ...
    updateWinner(){
        ...
        method: 'post',
        maxBodyLength: Infinity,
        url: 'https://501a-102-89-33-66.ngrok-free.app/bitplay/api/users/winner',
        headers: { 
            'Content-Type': 'application/json'
        },
        data : data
